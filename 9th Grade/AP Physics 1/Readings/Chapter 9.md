...
- if there is a net external force on the system, the center of mass accelerates as though all of the mass of the system were concentrated into the blob at the center of mask. If there is zero net external force on the system, the center of mass does not accelerate.